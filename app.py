        ...
        if enviado:
            try:
                ...
                try:
                    ...
                    msg["To"] = email or config["EMAIL_USER"]
                    ...
                    server.sendmail(config["EMAIL_USER"], [email or config["EMAIL_USER"]], msg.as_string())
                    server.quit()
                    ...
                    st.warning(f"Aviso: Não foi possível enviar o e-mail ({str(e)}), mas o arquivo foi salvo localmente.")
